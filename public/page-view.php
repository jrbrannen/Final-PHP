...
// displays weather widget on page view
$ch = curl_init();
...
// displays articles widget on page view
$ch = curl_init();
...
// displays faq widget on page view
$ch = curl_init();
       
    // set url
    curl_setopt($ch, CURLOPT_URL, 'http://localhost/wdv441/week14/Final/public/faq-widget.php');
